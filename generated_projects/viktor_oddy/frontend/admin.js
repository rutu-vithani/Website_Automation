...
(function () {
  ...
  // On page load, check whether we already have a valid admin session
  // (e.g. the tab was refreshed) and only then skip straight to the
  // dashboard - otherwise stay on the login screen and wait for the form.
  fetch('/api/admin/content')
    .then(function (r) {
